...
This package contains an ORM for an existing database schema, which hosts information
about sequencing runs. A Perl ORM for the same schema is defined in
