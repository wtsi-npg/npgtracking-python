...
"""ORM for the NPG tracking database schema.

These classes were generated by sqlacodegen to provide access to the tables
of the existing sequencing run tracking database schema.
...
class Designation(Base):
    ...
    id_designation: Mapped[int] = mapped_column(
...
class EntityType(Base):
    ...
    id_entity_type: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
...
class Manufacturer(Base):
    ...
    name: Mapped[Optional[str]] = mapped_column(
        CHAR(128, charset="latin1", collation="latin1_swedish_ci")
    )
...
class RunStatusDict(Base):
    ...
    temporal_index: Mapped[int] = mapped_column(SMALLINT(unsigned=True), nullable=False)
...
class Tag(Base):
    ...
    id_tag: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
...
class User(Base):
    ...
    id_user: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    iscurrent: Mapped[int] = mapped_column(
...
class Usergroup(Base):
    ...
    id_usergroup: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
...
class Annotation(Base):
    ...
    id_annotation: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    id_user: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
...
class EventType(Base):
    ...
    id_event_type: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    description: Mapped[str] = mapped_column(
        CHAR(64), nullable=False, server_default=text("''")
    )
...
class InstrumentFormat(Base):
    ...
    days_between_washes: Mapped[Optional[int]] = mapped_column(INTEGER(unsigned=True))
    runs_between_washes: Mapped[Optional[int]] = mapped_column(INTEGER(unsigned=True))
...
class TagFrequency(Base):
    ...
    id_tag_frequency: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
...
class User2usergroup(Base):
    ...
    id_user_usergroup: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    id_user: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
    ...
    level: Mapped[Optional[int]] = mapped_column(TINYINT(unsigned=True))
...
class Event(Base):
    ...
    id_event: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
...
class Instrument(Base):
    ...
    id_instrument: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    name: Mapped[str] = mapped_column(
        CHAR(32, charset="ascii", collation="ascii_general_ci"),
        nullable=False,
        server_default=text("''"),
    )
    id_instrument_format: Mapped[int] = mapped_column(
    ...
    percent_complete: Mapped[Optional[int]] = mapped_column(TINYINT(unsigned=True))
...
class InstrumentAnnotation(Base):
    ...
    id_instrument_annotation: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
...
class InstrumentDesignation(Base):
    ...
    id_instrument_designation: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    id_instrument: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
    id_designation: Mapped[int] = mapped_column(INTEGER(unsigned=True), nullable=False)
...
class InstrumentMod(Base):
    ...
    id_instrument_mod: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    id_instrument: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
...
class InstrumentStatus(Base):
    ...
    id_instrument_status: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    id_instrument: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
...
class Run(Base):
    ...
    id_run: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    id_instrument: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
    )
    ...
    actual_cycle_count: Mapped[Optional[int]] = mapped_column(BIGINT(unsigned=True))
    expected_cycle_count: Mapped[Optional[int]] = mapped_column(BIGINT(unsigned=True))
    id_run_pair: Mapped[Optional[int]] = mapped_column(BIGINT(unsigned=True))
    batch_id: Mapped[Optional[str]] = mapped_column(
        String(255), comment="LIMS-specific or user-defined identifier for run data"
    )
...
class InstrumentStatusAnnotation(Base):
    ...
    id_annotation: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
...
class RunAnnotation(Base):
    ...
    id_run_annotation: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    ...
    run_current_ok: Mapped[Optional[int]] = mapped_column(TINYINT(unsigned=True))
    current_cycle: Mapped[Optional[int]] = mapped_column(BIGINT(unsigned=True))
...
class RunLane(Base):
    ...
    id_run_lane: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    id_run: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
    )
    ...
    position: Mapped[Optional[int]] = mapped_column(
        INTEGER(unsigned=True), server_default=text("'0'")
    )
...
class RunRead(Base):
    ...
    id_run_read: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    id_run: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
    )
...
class StCache(Base):
    ...
    id_cache: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    id_run: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
    )
...
class TagRun(Base):
    ...
    id_tag_run: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    id_run: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
    )
    id_tag: Mapped[int] = mapped_column(
...
class RunLaneAnnotation(Base):
    ...
    id_run_lane_annotation: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    id_run_lane: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
    id_annotation: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
...
class RunLaneStatus(Base):
    ...
    id_run_lane_status: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
...
class TagRunLane(Base):
    ...
    id_tag_run_lane: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), primary_key=True
    )
    id_run_lane: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, server_default=text("'0'")
